...
4. (Opcional) Si existen archivos `migration_*.sql` en `database/`, ejecútalos en orden:
    ```bash
    ../database/migration_add_simulacion.sql
    ../database/migration_add_bancos.sql
    ```
...
Este proyecto forma parte del monorepo unificado. Ver [`README.md`](../README.md) en la raíz para la estructura completa.
